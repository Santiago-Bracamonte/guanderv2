...
async function getRecentActivity(): Promise<{
  ...
  if (leftItems.length === 0) {
    leftItems = [
      {
        title: "Nuevo local registrado",
        description: "Gym FitPro · Hace 15 minutos",
      },
      {
        title: "Suscripción actualizada",
        description: "Barbería Moderna a Premium · Hace 1 hora",
      },
      {
        title: "Nuevo usuario registrado",
        description: "45 nuevos usuarios hoy",
      },
      {
        title: "Reporte generado",
        description: "Informe mensual · Hace 2 horas",
      },
    ];
  }
      ...
      >
        ...
        >
          ...
          <div className="flex items-end gap-2 mb-4">
            ...
            <div
              className="w-6 rounded-t"
              style={{ height: "60px", backgroundColor: "#4caf50" }}
            />
            <div
              className="w-6 rounded-t"
              style={{
            ...
            <div
              className="w-6 rounded-t"
              style={{ height: "70px", backgroundColor: "#4caf50" }}
            />
            <div
              className="w-6 rounded-t"
              style={{
            ...
            <div
              className="w-6 rounded-t"
              style={{ height: "80px", backgroundColor: "#4caf50" }}
            />
          </div>
